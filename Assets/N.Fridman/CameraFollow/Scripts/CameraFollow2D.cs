    ...
    public class CameraFollow2D : MonoBehaviour
    {
        ...
        private void FixedUpdate()
        {
            if (oldX == PersObject.transform.position.x && oldY == PersObject.transform.position.y)
            {
                ...
                {
                    CameraObject.orthographicSize = (CameraObject.orthographicSize - 0.5f * Time.deltaTime);
                }
            }
            else 
            {
                ...
                CameraObject.orthographicSize = (CameraObject.orthographicSize + 2 * Time.deltaTime * 1.4f);
...
//            }
            ...
            if (this.playerTransform)
            {
                ...
                Vector3 pos = Vector3.Lerp(this.transform.position, target, this.movingSpeed * Time.deltaTime * 1.3f);
